...
import (
	...
	"github.com/eiixy/monorepo/internal/data/example/ent/operationlog"
...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[0] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			account.FieldNickname: {Type: field.TypeString, Column: account.FieldNickname},
			account.FieldPassword: {Type: field.TypeString, Column: account.FieldPassword},
		},
	}
...
func (f *AccountFilter) WhereNickname(p entql.StringP) {
	f.Where(p.Field(account.FieldNickname))
}

// WherePassword applies the entql string predicate on the password field.
func (f *AccountFilter) WherePassword(p entql.StringP) {
	f.Where(p.Field(account.FieldPassword))
}
